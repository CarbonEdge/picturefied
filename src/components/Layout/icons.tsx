export function IconGrid({ active = false }: { active?: boolean }) {
  const stroke = active ? 'url(#grad-icon)' : 'currentColor'
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" strokeWidth="1.8" aria-hidden="true" focusable="false">
      {active && (
        <defs>
...
export function IconPlus() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true" focusable="false">
